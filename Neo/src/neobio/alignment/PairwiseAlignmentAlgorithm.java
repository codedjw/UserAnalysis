...
public abstract class PairwiseAlignmentAlgorithm
{
	...
	public void loadSequences (String input1, String input2) throws InvalidSequenceException 
		{
			// when new sequences are loaded, the
			// alignment and score needs to be recomputed
			this.alignment = null;
	 ...
	 * @see FactorSequence
	 */
	protected abstract void loadSequencesInternal (Reader input1, Reader input2)throws IOException, InvalidSequenceException;
	
	protected abstract void loadSequencesInternal (String input1, String input2) throws InvalidSequenceException;
